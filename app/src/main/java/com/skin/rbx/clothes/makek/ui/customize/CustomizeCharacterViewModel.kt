...
import com.skin.rbx.clothes.makek.data.model.custom.ItemColorImageModel
...
import com.skin.rbx.clothes.makek.data.model.custom.LayerListModel
import com.skin.rbx.clothes.makek.data.model.custom.LayerTransformModel
...
class CustomizeCharacterViewModel : ViewModel() {
    ...
    suspend fun setBottomNavigationListDefault(targetLayerIndex: Int = -1) {
        ...
        if (itemNavList.size > firstLayerIndex) {
            ...
            val hasNone = firstNavItems.firstOrNull()?.path == com.skin.rbx.clothes.makek.core.utils.key.AssetsKey.NONE_LAYER
            val hasRandom = firstNavItems.firstOrNull()?.path == com.skin.rbx.clothes.makek.core.utils.key.AssetsKey.RANDOM_LAYER
