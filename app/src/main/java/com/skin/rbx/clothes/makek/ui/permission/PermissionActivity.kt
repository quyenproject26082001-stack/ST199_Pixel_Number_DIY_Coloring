package com.skin.rbx.clothes.makek.ui.permission
...
import com.skin.rbx.clothes.makek.databinding.ActivityPermissionBinding
...
class PermissionActivity : BaseActivity<ActivityPermissionBinding>() {
    ...
    override fun initText() {
        ...
        binding.txtPer.apply {
            typeface = ResourcesCompat.getFont(this@PermissionActivity, R.font.game_paused_demo_regular)
            text = getString(
                R.string.permission_message_format,
