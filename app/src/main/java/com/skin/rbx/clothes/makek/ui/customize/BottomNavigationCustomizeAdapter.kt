...
import com.skin.rbx.clothes.makek.databinding.ItemBottomNavigationBinding
...
//            )
            ...
            if (item.isSelected) {
                ...
                cvContent.strokeColor = ContextCompat.getColor(root.context, R.color.app)
            } else {
                imvImage.setBackgroundColor(Color.TRANSPARENT)
