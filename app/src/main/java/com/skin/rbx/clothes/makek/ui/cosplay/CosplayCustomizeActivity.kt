...
import com.skin.rbx.clothes.makek.databinding.ActivityCosplayCustomizeBinding
import com.skin.rbx.clothes.makek.dialog.CosplayResultDialog
import com.skin.rbx.clothes.makek.ui.customize.BottomNavigationCustomizeAdapter
import com.skin.rbx.clothes.makek.ui.customize.ColorLayerCustomizeAdapter
import com.skin.rbx.clothes.makek.ui.customize.CustomizeCharacterViewModel
import com.skin.rbx.clothes.makek.ui.customize.LayerCustomizeAdapter
...
class CosplayCustomizeActivity : BaseActivity<ActivityCosplayCustomizeBinding>() {
    ...
    override fun viewListener() {
        binding.apply {
            ...
            btnColor.tap(300) { if (binding.flColor.visibility == View.VISIBLE) binding.flColor.gone() else binding.flColor.gone() }
            actionBar.apply {
