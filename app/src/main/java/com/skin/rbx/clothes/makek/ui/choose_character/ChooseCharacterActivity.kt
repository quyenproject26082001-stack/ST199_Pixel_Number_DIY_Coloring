...
import com.skin.rbx.clothes.makek.ui.random_character.RandomCharacterActivity
...
import com.skin.rbx.clothes.makek.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.skin.rbx.clothes.makek.data.model.custom.CustomizeModel>) {
    ...
    override fun viewListener() {
        ...
        chooseCharacterAdapter.onItemClick = { position, model ->
            ...
            AdmobEvent.logEvent(this@ChooseCharacterActivity, "click_item_${model.dataName}", null)
        ...
        binding.actionBar.apply {
          ...
          tvCenter.setText(R.string.category)
            tvCenter.updateLayoutParams<ConstraintLayout.LayoutParams> {
                width = 0
                marginStart = UnitHelper.dpToPxInt(resources, 20f)
                marginEnd = UnitHelper.dpToPxInt(resources, 20f)
            }
            setTextActionBar(tvCenter, getString(R.string.maker))
            tvCenter.select()
        }
    }
