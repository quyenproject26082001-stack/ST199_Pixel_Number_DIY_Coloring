...
import com.skin.rbx.clothes.makek.databinding.ItemMyDesignBinding
import java.io.File
...
class MyDesignAdapter : BaseAdapter<MyAlbumModel, ItemMyDesignBinding>(ItemMyDesignBinding::inflate) {
    ...
    override fun onBind(binding: ItemMyDesignBinding, item: MyAlbumModel, position: Int) {
        binding.apply {
            ...
            if (item.isSelected) {
                btnSelect.setImageResource(R.drawable.ic_slt_item)
                frameCover.visible()
            } else {
                btnSelect.setImageResource(R.drawable.ic_uslt_item)
                frameCover.gone()
            }
