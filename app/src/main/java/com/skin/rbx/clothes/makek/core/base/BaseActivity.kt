package com.skin.rbx.clothes.makek.core.base
...
import com.skin.rbx.clothes.makek.core.extensions.enableMarqueeTextViews
...
import com.skin.rbx.clothes.makek.core.helper.SharePreferenceHelper
import com.skin.rbx.clothes.makek.core.helper.SoundHelper
import com.skin.rbx.clothes.makek.dialog.WaitingDialog
...
abstract class BaseActivity<T : ViewBinding> : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.root.enableMarqueeTextViews()
        setUpUI()
