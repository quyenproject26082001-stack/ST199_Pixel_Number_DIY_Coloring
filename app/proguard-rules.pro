...
-keep class com.skin.rbx.clothes.makek.ui.splash.SplashActivity.** {*; }
-keep class com.skin.rbx.clothes.makek.data.** {*; }

# Gson models outside the data package
-keep class com.skin.rbx.clothes.makek.ui.** { *; }
